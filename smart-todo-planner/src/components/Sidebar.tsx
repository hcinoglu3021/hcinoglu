...
const navItems = [
  ...
  { to: '/tasks', label: 'All Tasks', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
  { to: '/today', label: 'Today', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  { to: '/priority', label: 'Priority', icon: 'M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V2' },
  ...
  { to: '/focus', label: 'Focus Mode', icon: 'M15 12a3 3 0 11-6 0 3 3 0 016 0z M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z' },
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 z-40 h-full w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transform transition-transform duration-200 lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-2">
              ...
              <span className="text-base font-bold text-gray-900 dark:text-white">Smart Todo</span>
            </div>
            <button className="lg:hidden text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" onClick={() => setSidebarOpen(false)}>
